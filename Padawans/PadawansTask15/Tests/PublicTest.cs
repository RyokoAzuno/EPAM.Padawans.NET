...
namespace PadawansTask15.Tests
{
    ...
    public class PublicTest
    {
        ...
        [Test]
        public void My_GetEvenItemsTests()
        {
            var target = new EnumerableTask();
            IEnumerable<string> data = new string[] { "aaa", "aaabbbb", "cccbbbb", null };
            string prefix = "b";
            CollectionAssert.AreEqual(target.GetPrefixItems(data, prefix), new string[] { });
        }
        [Test]
        public void My_GetEvenItemsTests_UpperCheck()
        {
            var target = new EnumerableTask();
            IEnumerable<string> data = new string[] { "A", "horse,", "a", "kingdom", "for", "a", "horse!" };
            string prefix = "HORSE";
            CollectionAssert.AreEqual(target.GetPrefixItems(data, prefix), new string[] { "horse,", "horse!"});
        }
        #endregion
