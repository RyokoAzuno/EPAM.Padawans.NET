...
namespace PadawansTask7.Tests
{
    ...
    public class PublicTest
    {
        ...
        [Test]
        public void My_OrderStringsByLength_ArrayElememtIsNull_ThrowArgumentNullException()
        {
            string[] array = { "How", "Is", null, "Life" };
            Assert.Throws<System.ArgumentNullException>(() => StringExtension.OrderStringsByLength(array));
        }
    }
}
